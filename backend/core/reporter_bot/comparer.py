...
class ReportComparer:
    ...
    # Estados de interés para el filtrado (órdenes a revisar / sin movimiento)
    ESTADOS_INTERES = [
        'BODEGA DESTINO', 'DESPACHADA', 'EN BODEGA ORIGEN', 'EN BODEGA TRANSPORTADORA',
        'EN CAMINO', 'EN DESPACHO', 'EN PROCESAMIENTO',
        'EN REPARTO', 'EN RUTA', 'EN TRANSITO', 'ENTREGADA A CONEXIONES',
        'ENTREGADO A TRANSPORTADORA', 'NOVEDAD SOLUCIONADA',
        'TELEMERCADEO',
        # Estados adicionales
        'EN TRANSITO EN CIUDAD INTERMEDIA', 'EN ZONA DE DISTRIBUCION', 'EN REEXPEDICION',
        'SOLUCIONADA EN MALLA', 'MERCANCIA RECOGIDA', 'EN DISTRIBUCION',
        'EN TRASLADO NACIONAL', 'NO ENTREGADO', 'REAGENDADO',
        'LLEGO A OFICINA DE DESTINO', 'FISICO NO RECIBIDO', 'INTENTO DE ENTREGA',
        'ENVIO ADMITIDO', 'REENVIO', 'REPARTO', 'TRANSITO REGIONAL',
        'CENTRO ACOPIO', 'DESPACHADO PARA BODEGA', 'EN CONFIRMACION TELEFONICA',
        'EN PUNTO DROOP', 'EN TERMINAL ORIGEN', 'EN TRANSPORTE', 'EN TERMINAL DESTINO',
    ]
