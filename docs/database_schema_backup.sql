-- DropTools - Copia del esquema de la base de datos
-- Generado: 2026-02-10 (tras aplicar migraciones core 0011, 0012, 0013)
-- Origen: docs/droptools_db.sql
-- Migraciones aplicadas en BD: core.0011_reporter_weight_limits, 0012_proxy_blocked_status_and_fields, 0013_analytics_models
...
-- Tabla de tokens para DRF TokenAuthentication (login API).
--
...
-- Columnas faltantes en unique_product_clusters (DSA v1.0: vectores y metadata)
ALTER TABLE public.unique_product_clusters ADD COLUMN IF NOT EXISTS visual_centroid public.vector(1152);
ALTER TABLE public.unique_product_clusters ADD COLUMN IF NOT EXISTS visual_medoid_1 public.vector(1152);
ALTER TABLE public.unique_product_clusters ADD COLUMN IF NOT EXISTS visual_medoid_2 public.vector(1152);
ALTER TABLE public.unique_product_clusters ADD COLUMN IF NOT EXISTS visual_medoid_3 public.vector(1152);
ALTER TABLE public.unique_product_clusters ADD COLUMN IF NOT EXISTS medoid_meta jsonb DEFAULT '{}';
ALTER TABLE public.unique_product_clusters ADD COLUMN IF NOT EXISTS market_opportunity_score numeric(5,2) DEFAULT 0.0;
ALTER TABLE public.unique_product_clusters ADD COLUMN IF NOT EXISTS taxonomy_type character varying(50) DEFAULT 'UNKNOWN';
ALTER TABLE public.unique_product_clusters ADD COLUMN IF NOT EXISTS validation_log text;
...
CREATE TABLE IF NOT EXISTS public.domain_reputation (
    ...
    is_shopify boolean,
    shopify_likely_score double precision DEFAULT 0.0,
    shopify_likely_reasons jsonb DEFAULT '{}',
    shopify_last_checked_at timestamp with time zone,
    shopify_cache_expires_at timestamp with time zone,
    pixel_ids character varying(50)[],
    detected_apps character varying(50)[],
    has_active_ads boolean DEFAULT false,
    ads_last_checked_at timestamp with time zone,
    ads_cache_expires_at timestamp with time zone,
    ads_library_url character varying(500),
    ads_count_recent integer DEFAULT 0,
    ads_evidence jsonb DEFAULT '{}'
);
...
CREATE TABLE IF NOT EXISTS public.market_analysis_reports (
    ...
    search_fingerprint jsonb DEFAULT '{}',
    candidates_found_raw integer DEFAULT 0,
    shopify_likely_candidates_count integer DEFAULT 0,
    candidates_processed integer DEFAULT 0,
    direct_competitors_count integer DEFAULT 0,
    indirect_competitors_count integer DEFAULT 0,
    competitors_with_ads integer DEFAULT 0,
    supplier_saturation_score double precision DEFAULT 0.0,
    market_saturation_score double precision DEFAULT 0.0,
    final_score double precision DEFAULT 0.0,
    audit_log jsonb DEFAULT '[]',
    market_state character varying(50) DEFAULT 'PENDING'
);

--
-- Name: competitor_findings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE IF NOT EXISTS public.competitor_findings (
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    report_id bigint NOT NULL,
    domain_ref_id bigint,
    url_found character varying(1000) NOT NULL,
    title_detected character varying(500),
    price_detected numeric(10,2),
...
-- =============================================================================
-- TABLAS DEL REPORTADOR (Dropi / workflow de reportes)
-- =============================================================================
-- La app usa AUTH_USER_MODEL = core.User con db_table = 'users'.
-- Si este init se ejecuta y luego Django corre 'migrate', puede fallar porque
-- 'users' ya existe; en ese caso marcar como aplicadas: migrate --fake core 0001
-- (y 0002, 0003 si aplica).
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS public.users (
    ...
    full_name character varying(120) NOT NULL DEFAULT '',
    role character varying(10) NOT NULL DEFAULT 'CLIENT',
    subscription_tier character varying(10) NOT NULL DEFAULT 'BRONZE',
    subscription_active boolean NOT NULL DEFAULT false,
    execution_time time without time zone,
    dropi_email character varying(255),
    dropi_password character varying(255),
    created_at timestamp without time zone NOT NULL DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS public.order_reports (
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    user_id integer NOT NULL,
    order_phone character varying(50) NOT NULL,
    order_id character varying(100),
    tracking_number character varying(100),
    status character varying(50) NOT NULL DEFAULT 'proximo_a_reportar',
    report_generated boolean NOT NULL DEFAULT false,
    customer_name character varying(255),
    product_name text,
    order_state character varying(100),
...
CREATE TABLE IF NOT EXISTS public.raw_order_snapshots (
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    batch_id bigint NOT NULL,
    dropi_order_id character varying(100) NOT NULL,
    shopify_order_id character varying(100),
    guide_number character varying(100),
...
CREATE TABLE IF NOT EXISTS public.order_movement_reports (
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    batch_id bigint NOT NULL,
...
ALTER TABLE ONLY public.authtoken_token ADD CONSTRAINT authtoken_token_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) DEFERRABLE INITIALLY DEFERRED;
...
-- Reporter: PKs y UNIQUE
ALTER TABLE ONLY public.users ADD CONSTRAINT users_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.users ADD CONSTRAINT users_username_key UNIQUE (username);
ALTER TABLE ONLY public.order_reports ADD CONSTRAINT order_reports_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.workflow_progress ADD CONSTRAINT workflow_progress_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.report_batches ADD CONSTRAINT report_batches_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.raw_order_snapshots ADD CONSTRAINT raw_order_snapshots_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.order_movement_reports ADD CONSTRAINT order_movement_reports_pkey PRIMARY KEY (id);
CREATE UNIQUE INDEX IF NOT EXISTS unique_active_report_per_order ON public.order_reports (user_id, order_phone) WHERE (status IN ('reportado', 'proximo_a_reportar'));

-- domain_reputation, market_analysis_reports, competitor_findings: PKs y UNIQUE
ALTER TABLE ONLY public.domain_reputation ADD CONSTRAINT domain_reputation_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.domain_reputation ADD CONSTRAINT domain_reputation_domain_key UNIQUE (domain);
ALTER TABLE ONLY public.market_analysis_reports ADD CONSTRAINT market_analysis_reports_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.competitor_findings ADD CONSTRAINT competitor_findings_pkey PRIMARY KEY (id);
...
CREATE INDEX IF NOT EXISTS authtoken_token_key_like ON public.authtoken_token USING btree (key varchar_pattern_ops);
...
CREATE INDEX IF NOT EXISTS idx_emb_visual ON public.product_embeddings USING hnsw (embedding_visual public.vector_cosine_ops) WITH (m='16', ef_construction='64');
...
-- market_intelligence_logs: índice HNSW para embedding_context (búsqueda por similitud)
CREATE INDEX IF NOT EXISTS idx_market_intelligence_embedding ON public.market_intelligence_logs USING hnsw (embedding_context public.vector_cosine_ops) WITH (m='16', ef_construction='64');

-- unique_product_clusters: índices HNSW para vectores (búsqueda por similitud)
CREATE INDEX IF NOT EXISTS idx_clusters_visual_centroid ON public.unique_product_clusters USING hnsw (visual_centroid public.vector_cosine_ops) WITH (m='16', ef_construction='64');
CREATE INDEX IF NOT EXISTS idx_clusters_visual_medoid_1 ON public.unique_product_clusters USING hnsw (visual_medoid_1 public.vector_cosine_ops) WITH (m='16', ef_construction='64');

-- domain_reputation, competitor_findings: índices
CREATE INDEX IF NOT EXISTS idx_domain_reputation_domain ON public.domain_reputation USING btree (domain);
CREATE INDEX IF NOT EXISTS idx_competitor_findings_report_match ON public.competitor_findings USING btree (report_id, match_type);


-- Reporter: índices
CREATE INDEX IF NOT EXISTS order_reports_user_order_phone_idx ON public.order_reports USING btree (user_id, order_phone);
CREATE INDEX IF NOT EXISTS order_reports_user_status_idx ON public.order_reports USING btree (user_id, status);
CREATE INDEX IF NOT EXISTS order_reports_user_report_generated_idx ON public.order_reports USING btree (user_id, report_generated);
CREATE INDEX IF NOT EXISTS order_reports_order_phone_idx ON public.order_reports USING btree (order_phone);
CREATE INDEX IF NOT EXISTS order_reports_next_attempt_time_idx ON public.order_reports USING btree (next_attempt_time);
CREATE INDEX IF NOT EXISTS workflow_progress_user_status_idx ON public.workflow_progress USING btree (user_id, status);
CREATE INDEX IF NOT EXISTS workflow_progress_user_started_at_idx ON public.workflow_progress USING btree (user_id, started_at);
CREATE INDEX IF NOT EXISTS report_batches_user_created_at_idx ON public.report_batches USING btree (user_id, created_at);
CREATE INDEX IF NOT EXISTS report_batches_account_email_idx ON public.report_batches USING btree (account_email);
CREATE INDEX IF NOT EXISTS raw_order_snapshots_dropi_order_id_idx ON public.raw_order_snapshots USING btree (dropi_order_id);
CREATE INDEX IF NOT EXISTS raw_order_snapshots_current_status_idx ON public.raw_order_snapshots USING btree (current_status);
CREATE INDEX IF NOT EXISTS raw_order_snapshots_batch_status_idx ON public.raw_order_snapshots USING btree (batch_id, current_status);
CREATE INDEX IF NOT EXISTS order_movement_reports_batch_resolved_idx ON public.order_movement_reports USING btree (batch_id, is_resolved);
...
-- domain_reputation, market_analysis_reports, competitor_findings: FKs
ALTER TABLE ONLY public.market_analysis_reports ADD CONSTRAINT market_analysis_reports_cluster_id_fkey FOREIGN KEY (cluster_id) REFERENCES public.unique_product_clusters(cluster_id) ON DELETE CASCADE;
ALTER TABLE ONLY public.competitor_findings ADD CONSTRAINT competitor_findings_report_id_fkey FOREIGN KEY (report_id) REFERENCES public.market_analysis_reports(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.competitor_findings ADD CONSTRAINT competitor_findings_domain_ref_id_fkey FOREIGN KEY (domain_ref_id) REFERENCES public.domain_reputation(id) ON DELETE SET NULL;

-- Reporter: FKs (referencian users y entre sí)
ALTER TABLE ONLY public.order_reports ADD CONSTRAINT order_reports_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.workflow_progress ADD CONSTRAINT workflow_progress_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.report_batches ADD CONSTRAINT report_batches_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.raw_order_snapshots ADD CONSTRAINT raw_order_snapshots_batch_id_fkey FOREIGN KEY (batch_id) REFERENCES public.report_batches(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.order_movement_reports ADD CONSTRAINT order_movement_reports_batch_id_fkey FOREIGN KEY (batch_id) REFERENCES public.report_batches(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.order_movement_reports ADD CONSTRAINT order_movement_reports_snapshot_id_fkey FOREIGN KEY (snapshot_id) REFERENCES public.raw_order_snapshots(id) ON DELETE CASCADE;
